...
# processor = DetrImageProcessor.from_pretrained("facebook/detr-resnet-50", local_files_only=True)
processor = DetrImageProcessor.from_pretrained("F:/models/detr-resnet")
# model = DetrForObjectDetection.from_pretrained("facebook/detr-resnet-50", revision="no_timm")
model = DetrForObjectDetection.from_pretrained("F:/models/detr-resnet")
